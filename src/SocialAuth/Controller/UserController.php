...
use Hybrid_Auth;
use SocialAuth\Mapper\Exception as MapperException;
...
class UserController extends AbstractActionController
{
    ...
    {        
        ...
        $redirectUrl = $this->url()->fromRoute('social-auth-user/authenticate/provider', array('provider' => $provider), array('query' => $query));
        echo "providerLoginAction :".$redirectUrl;
        print_r($_GET);
    ...
    {   
        //echo "providerAuthenticateAction :";
        //print_r($_GET);
        //exit;     
        ...
        $this->zfcUserAuthentication()->setAuthAdapter($this->getServiceLocator()->get('SocialAuth-AuthenticationAdapterChain'));
